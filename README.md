...
5. [GarmentMeasurement](https://github.com/mbotsch/GarmentMeasurements): A PCA-based identity model trained on the CASERS dataset, suitable for specialized use cases involving garment fitting and measurement.
